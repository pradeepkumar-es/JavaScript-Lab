...
You can go through this documentation to learn more about Currying. (https://javascript.info/currying-partials)
...
csum(1)(2)(3) === 6; // true
Explanation:
The curried function csum(1)(2)(3) should return the same value as sum(1, 2, 3), which is 6.
...
csum()()(1, 2, 3) === 6; // true
Explanation:
You should be able to pass the parameters in any way, including all at once or none at all. The curried function csum()()(1, 2, 3) should return the same value as sum(1, 2, 3), which is 6.
...
Export the curry function - Export the `curry` function from your code using ESM. Make sure it's exported properly and is the default export.
Implement the curry function correctly - The `curry` function should return a **curried** version of the given function, such that it can be called in different ways but produce the 
same result as the original function. For instance, if you have the `sum` function `sum(1, 2, 3)`, make sure your `curry` function` csum(1)(2)(3)` produces the same result. ```
123456151614789101311121718
*/
/**
/**
 * @param {Function} fn
